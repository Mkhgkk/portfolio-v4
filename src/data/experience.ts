...
export const experience: ExperienceEntry[] = [
  {
    ...
    highlights: [
      ...
      'Developed real-time object detection pipeline with YOLOv11 and TensorRT (GPU accelerated)',
      'Built React-based monitoring dashboard with WebRTC streaming supporting 10+ violation types',
      ...
      'Implemented REST API using Flask and built streaming server using GStreamer and MediaMTX',
      'Designed microservices architecture with Docker for scalable deployment on NVIDIA GPU infrastructure',
    ],
    tech: ['Python', 'React', 'TypeScript', 'Flask', 'TensorRT', 'YOLOv11', 'WebRTC', 'GStreamer', 'Docker', 'MediaMTX', 'SocketIO'],
  },
  {
  ...
  },
  {
    ...
    tech: ['React Native', 'Node.js', 'MongoDB', 'Mapbox', 'Kotlin', 'ML Kit', 'Nginx', 'SocketIO'],
  },
  {
